...
public class LSETest {
    ...
    public static void main(String[] args) {
        ...
        printHeader("juego.model.EstructurasUtilizadas.LSE — Lista vacía");
        ...
        printHeader("juego.model.EstructurasUtilizadas.LSE — add (inserción al final)");
        ...
        printHeader("juego.model.EstructurasUtilizadas.LSE — addFirst (inserción al inicio)");
        ...
        printHeader("juego.model.EstructurasUtilizadas.LSE — get (búsqueda por valor)");
        ...
        printHeader("juego.model.EstructurasUtilizadas.LSE — del (eliminación por valor)");
        ...
        printHeader("juego.model.EstructurasUtilizadas.LSE — getAt (acceso por índice)");
        ...
        printHeader("juego.model.EstructurasUtilizadas.LSE — insertAt (inserción por índice)");
        ...
        printHeader("juego.model.EstructurasUtilizadas.LSE — removeAt (eliminación por índice)");
        ...
        printHeader("juego.model.EstructurasUtilizadas.LSE — getIterador");
        test_iterador_recorreTodosLosElementos();
        test_iterador_ordenCorrecto();
        test_iterador_hasNext_falsoAlTerminar();

        printHeader("juego.model.EstructurasUtilizadas.LSE — toString");
        test_toString_unElemento();
        test_toString_variosElementos();

        printHeader("juego.model.EstructurasUtilizadas.LSE — tipos genéricos");
        test_genericos_conStrings();
        test_genericos_conDoubles();

        printHeader("juego.model.EstructurasUtilizadas.LSE — volumen");
        test_volumen_500elementos();

        // ── juego.model.EstructurasUtilizadas.LSE ORDENADA ───────────────────────────────────────────────
    ...
    // ==================================================================
    // juego.model.EstructurasUtilizadas.LSE — LISTA VACÍA
    // ==================================================================
    ...
    // ==================================================================
    // juego.model.EstructurasUtilizadas.LSE — add
    // ==================================================================
    ...
    // ==================================================================
    // juego.model.EstructurasUtilizadas.LSE — addFirst
    // ==================================================================
    ...
    // ==================================================================
    // juego.model.EstructurasUtilizadas.LSE — get
    // ==================================================================
    ...
    // ==================================================================
    // juego.model.EstructurasUtilizadas.LSE — del
    // ==================================================================
    ...
    // ==================================================================
    // juego.model.EstructurasUtilizadas.LSE — getAt
    // ==================================================================
    ...
    // ==================================================================
    // juego.model.EstructurasUtilizadas.LSE — insertAt
    // ==================================================================
    ...
    // ==================================================================
    // juego.model.EstructurasUtilizadas.LSE — removeAt
    // ==================================================================
    ...
    // ==================================================================
    // juego.model.EstructurasUtilizadas.LSE — getIterador
    // ==================================================================
    ...
    // ==================================================================
    // juego.model.EstructurasUtilizadas.LSE — toString
    // ==================================================================
    ...
    // ==================================================================
    // juego.model.EstructurasUtilizadas.LSE — tipos genéricos
    // ==================================================================
    ...
    // ==================================================================
    // juego.model.EstructurasUtilizadas.LSE — volumen
    // ==================================================================
    ...
    // ==================================================================
    // juego.model.EstructurasUtilizadas.LSE ORDENADA — inserción ordenada
    // ==================================================================
    ...
    // ==================================================================
    // juego.model.EstructurasUtilizadas.LSE ORDENADA — operaciones heredadas
    // ==================================================================
    ...
    static void test_ordenada_del_vacia_lanzaListaVaciaExceptions() {
        // Igual que juego.model.EstructurasUtilizadas.LSE: del() en vacía lanza ListaVaciaExceptions
        LSEOrdenada<Integer> l = new LSEOrdenada<Integer>();
    ...
    static void test_ordenada_addFirst_noMantienOrden_aviso() {
        /*
         * addFirst() es heredado de juego.model.EstructurasUtilizadas.LSE y NO mantiene el orden.
    ...
    // ==================================================================
    // juego.model.EstructurasUtilizadas.LSE ORDENADA — tipos genéricos
    // ==================================================================
    ...
    // ==================================================================
    // juego.model.EstructurasUtilizadas.LSE ORDENADA — volumen
    // ==================================================================
