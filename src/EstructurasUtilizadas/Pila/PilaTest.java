package EstructurasUtilizadas.Pila;
import Exceptions.PilaVaciaExceptions;
/**
 * Suite de tests manuales para EstructurasUtilizadas.Pila.
 ...
 *   - Tipos genéricos siempre explícitos: new EstructurasUtilizadas.Pila<Integer>().
 */
public class PilaTest {
    ...
    static void test_volumen_pushPop_alternados() {
        /*
         * ANÁLISIS DEL COMPORTAMIENTO REAL (aprendiendo de la EstructurasUtilizadas.ListaCircular):
         *
         * En cada iteración:
         *   - push(i)        → cima es i
